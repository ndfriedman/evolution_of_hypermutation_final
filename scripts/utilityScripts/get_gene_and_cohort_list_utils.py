...
def get_essential_genes(depMapPath = 'files/infoFiles/projectAchillesDepMapData.csv', mode='getEssentialGenes'):
...
def get_cancer_neutral_genes(depMapPath = 'files/infoFiles/projectAchillesDepMapData.csv'):
